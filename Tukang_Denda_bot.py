...
async def set_commands(app):
    await app.bot.set_my_commands([
        ...
        BotCommand("WC", "Izin WC 10 menit"),
        BotCommand("rokok", "Izin rokok 5 menit"),
        ...
        BotCommand("nyanyi", "Admin nyanyi user"),
